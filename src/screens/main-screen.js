  ...
  render() {
    return (
      <View style={styles.container}>
        <Text style={styles.header}>Lottie Animations</Text>
        <View style={styles.buttonsContainer}>
          ...
          >
            <Text style={styles.buttonText}>Basic Animation</Text>
          ...
          >
            <Text style={styles.buttonText}>Loading Animation</Text>
            <Image source={rightArrow} />
          </TouchableOpacity>
          ...
          >
            <Text style={styles.buttonText}>Progress Animation</Text>
            <Image source={rightArrow} />
          </TouchableOpacity>
          ...
          <TouchableOpacity
            activeOpacity={0.5}
            style={styles.button}
            onPress={this.handlePressCallbackAnimation}
          >
            <Text style={styles.buttonText}>Callback Animation</Text>
            <Image source={rightArrow} />
          </TouchableOpacity>
          ...
          >
            <Text style={styles.buttonText}>Button Transition Animation</Text>
            <Image source={rightArrow} />
          </TouchableOpacity>
          {/* <TouchableOpacity
            activeOpacity={0.5}
